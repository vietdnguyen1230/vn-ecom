...
const Footer = () => {
  ...
  return (
    <footer className="text-white bg-gray-800 lg:grid lg:grid-cols-5 mt-20">
      <aside className="hidden lg:relative lg:col-span-2 lg:block">
        <Image
          className="absolute inset-0 object-cover w-full h-full"
          src="https://images.unsplash.com/photo-1530908295418-a12e326966ba?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
          alt="Air"
          layout="fill"
        />
      </aside>
      ...
      <div className="px-4 py-16 sm:px-6 lg:px-8 lg:col-span-3">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <p className="font-medium">
              <span className="text-xs tracking-widest uppercase">Call Us</span>
        ...
        <div className="pt-12 mt-12 border-t border-gray-800">
          <div className="text-sm text-gray-300 sm:items-center sm:justify-between sm:flex">
            <p className="mt-0 sm:mt-0">&copy; 2022 Viet D. Nguyen</p>
          </div>
        </div>
      </div>
    </footer>
